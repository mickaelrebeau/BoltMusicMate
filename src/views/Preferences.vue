  ...
  <div class="space-y-8">
    ...
    <div class="card space-y-6">
      ...
      <div class="flex flex-wrap gap-2">
        <button
          v-for="genre in preferencesStore.availableGenres"
          :key="genre"
          @click="preferencesStore.toggleGenre(genre)"
          :class="[
            'btn',
      ...
      <div class="space-y-4">
        ...
        <div v-if="searchResults.length > 0" class="space-y-2">
          ...
          >
            ...
            <button
              @click="preferencesStore.addArtist(artist)"
        ...
        <div class="space-y-2">
          <div
            v-for="artist in preferencesStore.favoriteArtists"
            :key="artist.id"
          ...
          >
            ...
            <button
              @click="preferencesStore.removeArtist(artist.id)"
